  ...
  return (
    <div className='bg-[#8F0FBA] relative ' >
      ...
      <div className='lg:w-1/2 p-8 absolute lg:top-20 top-0 lg:p-10 text-center text-white left-0 right-0 mx-auto'>
        ...
        <div>
          <button className='border border-white rounded-md mx-2 p-3 w-32'>Discord</button>
          <button className='border border-white rounded-md mx-2 p-3 w-32'>Telegram</button>
        </div>
      </div>
    </div>
  );
